...
class CuentaBancaria {
    ...
    public CuentaBancaria(String tipoCuenta, double saldoInicial) {
        if (tipoCuenta.equals("A") || tipoCuenta.equals("B") || tipoCuenta.equals("C")) {
            ...
            System.out.println("Tipo de cuenta no valido. Debe ser A, B o C.");
            return;
        }

        if (tipoCuenta.equals("A") && saldoInicial > 50000) {
            System.out.println("El saldo inicial maximo para una cuenta tipo A es $50,000.");
            return;
        } else if (tipoCuenta.equals("B") && saldoInicial > 100000) {
            System.out.println("El saldo inicial maximo para una cuenta tipo B es $100,000.");
            return;
        }
    ...
    public void depositar(double monto) {
        ...
        if (tipoCuenta.equals("A") && saldo + monto > 50000) {
            System.out.println("El saldo maximo para este tipo de cuenta es $50,000.");
            return;
        } else if (tipoCuenta.equals("B") && saldo + monto > 100000) {
            System.out.println("El saldo maximo para este tipo de cuenta es $100,000.");
            return;
        }
    ...
    public void retirar(double monto) {
        ...
        if (tipoCuenta.equals("A") && saldo - monto < 1000) {
            System.out.println("El saldo minimo para este tipo de cuenta es $1,000.");
            return;
        } else if (tipoCuenta.equals("B") && saldo - monto < 5000) {
            System.out.println("El saldo minimo para este tipo de cuenta es $5,000.");
            return;
        } else if (tipoCuenta.equals("C") && saldo - monto < 10000) {
            System.out.println("El saldo minimo para este tipo de cuenta es $10,000.");
            return;
        }
